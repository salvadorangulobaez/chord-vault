...
class HelpScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('ChordVault - Ayuda y formato')),
      body: ListView(
        ...
        children: const [
          ...
          _Bullet('Notas/comentarios: líneas que empiecen con // (o NOTE: por compatibilidad).'),
          _Bullet('Separador entre canciones: línea con --- o dos líneas en blanco.'),
          _SectionTitle('Biblioteca'),
          _Bullet('Importar: menú de añadir en Biblioteca (desde texto o archivo .chordvault).'),
          _Bullet('Exportar: en modo selección podés copiar como texto o exportar archivo .chordvault.'),
          _SectionTitle('Notas'),
